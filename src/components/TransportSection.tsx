  ...
  const transportOptions = [
    {
      ...
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
          <path d="M17.8 19.2 16 11l3.5-3.5C21 6 21.5 4 21 3c-.5-.5-2.5 0-4.5 1.5L13 8 4.8 6.2c-.5-.1-.9.2-1.1.7l-1.2 3.6 7.5 4.6-3 3.1-3.6-.8-1.5 1.5 4.6 2.2 2.2 4.6 1.5-1.5-.8-3.6 3.1-3 4.6 7.5 3.6-1.2c.5-.2.8-.6.7-1.1z"/>
        </svg>
      ),
    },
    {
